...
import { BlindsIcon, CardSim, Check, CreditCard, Filter, HelpCircle, History, Mail, Menu, Phone, Plane, Search, Ticket, User, X } from "lucide-react"
            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <nav className="hidden md:flex items-center gap-2 ">
                        {navItems.map((item) => (
                            ...
                            >
                                <Button variant='ghost' className="rounded-none"> {item.name}</Button>
                            </Link>
                        ))}
                    </nav>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="max-w-md sm:max-w-lg rounded-none px-6 py-5">
                            <DialogHeader>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Avatar className="h-8 w-8 rounded-none bg-black p-0.5">
                                <AvatarImage src="https://github.com/shadcn.png" alt="User" />
                                <AvatarFallback className="rounded-none text-white bg-black">PM</AvatarFallback>
                            </Avatar>
                        </DialogTrigger>
                        <DialogContent className="max-w-sm sm:max-w-md rounded-none">
                            <DialogHeader>
